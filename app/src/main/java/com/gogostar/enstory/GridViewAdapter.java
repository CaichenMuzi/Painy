...
public class GridViewAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, final ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.iv = (ImageView) convertView.findViewById(R.id.gridview_item_img);
			holder.iv2 = (ImageView) convertView.findViewById(R.id.gridview_item_img2);
		...
		try {
			myBitmapUtils.display(holder.iv, pictureInfo.getVideo_img());
...
//				Bitmap bitmap = null;
//				// 从服务器获取Bitmap
//				bitmap = myUtil.getBitmap(finalPictureInfo.getVideo_img());
//				// 设置handlerUtil
